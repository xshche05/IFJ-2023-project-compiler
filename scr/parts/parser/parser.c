...
bool S() {
    ...
    switch (lookahead->type) {
        ...
        case TOKEN_EOF:
            ...
            break;
        default:
            sprintf(error_msg, "Syntax error [S]: expected ['TOKEN_FUNC', 'TOKEN_LET', 'TOKEN_CONTINUE', 'TOKEN_IF', 'TOKEN_WHILE', 'TOKEN_IDENTIFIER', 'TOKEN_RETURN', 'TOKEN_BREAK', 'TOKEN_VAR', 'TOKEN_FOR', 'TOKEN_EOF'], got %s\n", tokens_as_str[lookahead->type]);
            s = false;
    }
    return s;
}
...
bool RET_EXPR() {
    ...
    switch (lookahead->type) {
        ...
        default:
            ...
            sprintf(error_msg, "Syntax error [RET_EXPR]: expected ['EXPR', 'TOKEN_RIGHT_BRACE', 'TOKEN_EOF'], got %s\n", tokens_as_str[lookahead->type]);
            s = false;
    }
    return s;
}
...
bool PARAM_LIST() {
    ...
    switch (lookahead->type) {
        ...
        case TOKEN_RIGHT_BRACKET:
            ...
            break;
        default:
            sprintf(error_msg, "Syntax error [PARAM_LIST]: expected ['TOKEN_IDENTIFIER', 'TOKEN_UNDERSCORE', 'TOKEN_RIGHT_BRACKET'], got %s\n", tokens_as_str[lookahead->type]);
            s = false;
    }
    return s;
}
...
bool PARAM() {
    ...
    switch (lookahead->type) {
        ...
        case TOKEN_UNDERSCORE:
            ...
            break;
        default:
            sprintf(error_msg, "Syntax error [PARAM]: expected ['TOKEN_IDENTIFIER', 'TOKEN_UNDERSCORE'], got %s\n", tokens_as_str[lookahead->type]);
            s = false;
    }
    return s;
}
...
bool BR_EXPR() {
    ...
    switch (lookahead->type) {
        ...
        default:
            if (call_expr_parser(lookahead)) return true;
            sprintf(error_msg, "Syntax error [BR_EXPR]: expected ['EXPR', 'TOKEN_LET'], got %s\n", tokens_as_str[lookahead->type]);
            s = false;
    }
    return s;
}
...
bool CALL_PARAM_LIST() {
    ...
    switch (lookahead->type) {
        ...
        default:
            if (call_expr_parser(lookahead)) return true;
            sprintf(error_msg, "Syntax error [CALL_PARAM_LIST]: expected ['EXPR', 'TOKEN_IDENTIFIER', 'TOKEN_RIGHT_BRACKET'], got %s\n", tokens_as_str[lookahead->type]);
            s = false;
    }
    return s;
}
...
bool CALL_PARAM() {
    ...
    switch (lookahead->type) {
        ...
        default:
            if (call_expr_parser(lookahead)) return true;
            sprintf(error_msg, "Syntax error [CALL_PARAM]: expected ['TOKEN_IDENTIFIER', 'EXPR'], got %s\n", tokens_as_str[lookahead->type]);
            s = false;
    }
    return s;
}
...
bool TYPE() {
    ...
    switch (lookahead->type) {
        ...
        case TOKEN_DOUBLE_TYPE:
            ...
            break;
        default:
            sprintf(error_msg, "Syntax error [TYPE]: expected ['TOKEN_STRING_TYPE', 'TOKEN_INT_TYPE', 'TOKEN_BOOL_TYPE', 'TOKEN_DOUBLE_TYPE'], got %s\n", tokens_as_str[lookahead->type]);
            s = false;
    }
    return s;
}